...
export namespace Texture{
    ...
    export const createFromPixel = (w:number, h:number):Texture=>{
    ...
    export const createFromImageData = (imageData:ImageData):Texture=>{
        const canvas = document.createElement("canvas") as HTMLCanvasElement;
    ...
    export const createFromSrc = (src:string)=>{
        const img = new Image();
        img.src = src;
    };
}
