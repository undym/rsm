...
(function (Story3) {
    ...
    //冥界王朝宮クリア
    Story3.runMain30 = () => __awaiter(this, void 0, void 0, function* () {
        const f_empty = new Img("img/face/p_rs.jpg");
        const f_kabe = new Img("img/face/p_majo.jpg");
    ...
    //塔地下へのボタン
    Story3.runMain35a = () => __awaiter(this, void 0, void 0, function* () {
        const f_empty = new Img("img/face/p_rs.jpg");
    ...
    Story3.runMain36 = () => __awaiter(this, void 0, void 0, function* () {
        const f_empty = new Img("img/face/p_rs.jpg");
    ...
    Story3.runMain37 = () => __awaiter(this, void 0, void 0, function* () {
        ...
        Sound.moji.play();
        yield cwait();
        Util.msg.set("第37話『うずまきまみえる闇』", Color.L_GRAY);
        Sound.moji.play();
        yield cwait();
    });
    /**このストーリー後、ヴィクトリーヌ達との戦闘。 */
    Story3.runMain38 = () => __awaiter(this, void 0, void 0, function* () {
        const f_empty = new Img("img/face/p_rs.jpg");
        const f_pea = new Img("img/face/p_pea.jpg");
        const f_1 = new Img("img/face/p_1.jpg");
        const f_ruin = new Img("img/face/p_ruin.jpg");
        ...
        yield s.set(new Img("img/story/s_pic38.jpg"), [
        ...
        Sound.moji.play();
        yield cwait();
        Util.msg.set("第38話『畏れ多き出現』", Color.L_GRAY);
        Sound.moji.play();
        yield cwait();
    });
    /**塔地下801階クリア。 */
    Story3.runMain39 = () => __awaiter(this, void 0, void 0, function* () {
        const f_empty = new Img("img/face/p_rs.jpg");
        const f_pea = new Img("img/face/p_pea.jpg");
        const f_ruin = new Img("img/face/p_ruin.jpg");
        const s = new Story();
        yield s.set(new Img("img/story/s_pic39.jpg"), [
        ...
        */
        ...
        Sound.moji.play();
        yield cwait();
        Util.msg.set("第39話『ルインの不安』", Color.L_GRAY);
        Sound.moji.play();
        yield cwait();
    });
})(Story3 || (Story3 = {}));
